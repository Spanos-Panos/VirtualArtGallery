import {
  ...
  const ModelInner: FC<ModelInnerProps> = ({
    ...
    const content = useMemo<THREE.Object3D | null>(() => {
      if (ext === "glb" || ext === "gltf") return gltfData.scene?.clone() || null;
      if (ext === "fbx") return fbxData?.clone() || null;
      if (ext === "obj") return objData?.clone() || null;
      console.error("Unsupported format:", ext);
      return null;
    }, [url, ext, gltfData, fbxData, objData]);
